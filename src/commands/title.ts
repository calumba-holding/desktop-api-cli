...
export default class Title extends BeeperCommand {
  static override summary = 'Set a custom chat title'
  static override args = {
    chat: Args.string({ description: cliCopy.args.chatSelector, required: true }),
    title: Args.string({ description: 'New chat title', required: true }),
  }
