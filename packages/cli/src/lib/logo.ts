...
const scale = (source: string, width: number, height: number): string[] => {
...
const combine = (icon: string[], wordmark: string[], gap: number): string[] => {
...
export function renderStartupLogo(columns = process.stdout.columns ?? 80): string {
